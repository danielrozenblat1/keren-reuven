      ...
      <section ref={containerRef} className={styles.section} id="מי-אני">
        <div className={styles.container}>
          ...
          <strong>     ולחוות את ההורות שתמיד חלמתי עליה </strong>
              ...
              <p className={styles.paragraph}>
                אבל בפועל? המציאות הייתה אחרת. התקפי זעם, ויכוחים, משחקי כוח, וההרגשה שאני לא רואה באמת את הילד שלי. 
                אבל לא וויתרתי. אחרי החוויה עם הילד הראשון החליטתי שהילד השני יגדל אחרת - החלטתי ללמוד איך להיות ההורה שרציתי להיות. 
              ...
              <p className={styles.paragraph}>
                היום, כאימא לשני זעטוטים, מדריכת הורים ויועצת זוגית, אני יודעת בדיוק איך את מרגישה כשאת צועקת על הילד בבוקר ואז מרגישה אשמה כל היום.
              ...
              <p className={styles.paragraph}>
                התהליך איתי פרטני וייחודי לכל משפחה. כל הכלים שתקבלו ממני, יהיו מדויקים לסיטואציות שיקרו בזמן אמת בבית שלכם - בלי חירטוטים, כל האמת בפרצוף :)
